...
function Finder__ClearFilterTag(props) {
  ...
  var clearFilterTags = !value && valuesFacets.length > 0 && valuesFacets.flatMap(function (facetValue, i) {
    ...
    return list.map(function (v) {
      if (props.matrixState) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_28___default().createElement("a", {
          key: "".concat(facetKey, "-").concat(v),
          className: "v26-finder__clear-filter-tag",
          onClick: function onClick() {
            return updateQuery(v);
          },
          href: (0,_logic_hyper_link__WEBPACK_IMPORTED_MODULE_29__.hyperLink)(props.query, facet, undefined, undefined, v)
        }, v);
      } else {
  ...
  var clearSingleFilterTag = value && props.matrixState ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_28___default().createElement("a", {
    key: "".concat(facet.meta, "-").concat(value),
    "aria-label": "Clear the filter ".concat(value),
    className: "v26-finder__clear-filter-tag",
    href: (0,_logic_hyper_link__WEBPACK_IMPORTED_MODULE_29__.hyperLink)(props.query, facet, undefined, undefined, value)
...
Finder__ClearFilterTag.propTypes = {
  facet: (prop_types__WEBPACK_IMPORTED_MODULE_30___default().object).isRequired,
  query: (prop_types__WEBPACK_IMPORTED_MODULE_30___default().object).isRequired,
  update: (prop_types__WEBPACK_IMPORTED_MODULE_30___default().object).isRequired,
  config: (prop_types__WEBPACK_IMPORTED_MODULE_30___default().object).isRequired,
  value: (prop_types__WEBPACK_IMPORTED_MODULE_30___default().string),
  matrixState: (prop_types__WEBPACK_IMPORTED_MODULE_30___default().func).isRequired
};
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator.js */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var _shared_util__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../shared/util */ "./src/shared/util.tsx");
...
function hyperLink(query, facet, pageNumber, numberRank, facetValueInArray) {
  ...
  var flattenQuery = (0,_shared_util__WEBPACK_IMPORTED_MODULE_22__.flattenObj)(newQuery);
  return "?" + Object.entries(flattenQuery).filter(function (key) {
    ...
    var multiFacetNameCapitalized = normalizedKey.replace(/^./, function (c) {
    ...
    if (isArrayKey) {
      return encodeURIComponent("f\xB1".concat(multiFacetNameCapitalized, "|").concat(normalizedKey, "[]")) + "=" + encodeURIComponent(value);
    }
