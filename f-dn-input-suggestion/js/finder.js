...
function Finder__ClearFilterTag(props) {
  ...
  var clearFilterTag = value && props.matrixState ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_26___default().createElement("a", {
    ...
    href: (0,_logic_hyper_link__WEBPACK_IMPORTED_MODULE_27__.hyperLink)(props.query, facet, undefined, undefined, value, facet.facetName)
...
function hyperLink(query, facet, pageNumber, numberRank, facetValueInArray, facetNavName) {
  ...
  return "?" + Object.entries(flattenQuery).filter(function (key) {
    ...
    if (isArrayKey) {
      return encodeURIComponent("f\xB1".concat(facetNavName, "|").concat(normalizedKey, "[]")) + "=" + encodeURIComponent(value);
    }
