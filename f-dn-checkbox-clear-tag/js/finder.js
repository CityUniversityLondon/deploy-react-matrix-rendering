...
/* harmony import */ var _results_formatLabel__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../results/formatLabel */ "./src/shared/components/results/formatLabel.tsx");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../util */ "./src/shared/util.tsx");
...
function Finder__Results__Coursev26(props) {
  var _props$details$listMe, _props$details$listMe2, _props$details$listMe3, _props$details$listMe4, _props$details$listMe5, _props$details$listMe6, _props$details$listMe7, _props$query$facets, _props$details$listMe8, _props$details$listMe9, _props$details$listMe0, _props$details$listMe1, _props$details;
  ...
  if ((_props$details$listMe2 = props.details.listMetadata) !== null && _props$details$listMe2 !== void 0 && _props$details$listMe2.school) {
    ...
    switch (_school) {
      ...
      case "the city law school":
        schoolClassName = "v26-course__school-icon--law";
        break;
      case "school of science and technology":
        schoolClassName = "v26-course__school-icon--sst";
        break;
  ...
  var subtitle = ((_props$details$listMe3 = props.details.listMetadata) === null || _props$details$listMe3 === void 0 || (_props$details$listMe3 = _props$details$listMe3.type) === null || _props$details$listMe3 === void 0 ? void 0 : _props$details$listMe3[0]) || ((_props$details$listMe4 = props.details.listMetadata) === null || _props$details$listMe4 === void 0 || (_props$details$listMe4 = _props$details$listMe4.level) === null || _props$details$listMe4 === void 0 ? void 0 : _props$details$listMe4[0]) || null,
    award = props.details.listMetadata && props.details.listMetadata.qualification && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", {
      className: "card__tag"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", {
      className: "fas fa-fw fa-award icon",
      "aria-hidden": "true"
    }), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, "Award", props.details.listMetadata.qualification.length > 1 && "s", ":"), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, props.details.listMetadata.qualification.join(", "))),
    duration = ((_props$details$listMe5 = props.details.listMetadata) === null || _props$details$listMe5 === void 0 ? void 0 : _props$details$listMe5.duration) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", {
      className: "card__tag"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, "Duration:"), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("strong", null, props.details.listMetadata.duration[0]))),
    method = ((_props$details$listMe6 = props.details.listMetadata) === null || _props$details$listMe6 === void 0 ? void 0 : _props$details$listMe6.method) && ((_props$details$listMe7 = props.details.listMetadata) === null || _props$details$listMe7 === void 0 || (_props$details$listMe7 = _props$details$listMe7.level) === null || _props$details$listMe7 === void 0 ? void 0 : _props$details$listMe7[0]) !== "Short courses and professional development" && (((_props$query$facets = props.query.facets) === null || _props$query$facets === void 0 ? void 0 : _props$query$facets.method) || props.query.query.indexOf(props.details.listMetadata.method[0]) >= 0 || props.details.listMetadata.method[0].indexOf("Online") >= 0) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", {
      className: "card__tag"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", {
      className: "fa-solid fa-book-open-reader icon",
      "aria-hidden": "true"
    }), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, "Method", props.details.listMetadata.method.length > 1 && "s", " of study:"), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, (0,_util__WEBPACK_IMPORTED_MODULE_16__.uppercaseFirstLetterLowercaseRest)(Array.from(new Set(props.details.listMetadata.method)).join("|") // Remove any duplicates & format
    ).split("|").join(", "))),
    location = ((_props$details$listMe8 = props.details.listMetadata) === null || _props$details$listMe8 === void 0 ? void 0 : _props$details$listMe8.location) && String(props.details.listMetadata.location).toLowerCase() !== "tooting" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", {
      className: "card__tag"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", {
      className: "icon",
      "aria-hidden": "true"
      ...
      "aria-hidden": "true"
    })), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, "Location:"), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("strong", null, props.details.listMetadata.location.join("|") === "Online|Online" ? "Online" : props.details.listMetadata.location.join(", ")))),
    school = ((_props$details$listMe9 = props.details.listMetadata) === null || _props$details$listMe9 === void 0 ? void 0 : _props$details$listMe9.school) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", {
      className: "card__tag"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", {
      className: "icon",
      "aria-hidden": "true"
      ...
      "aria-hidden": "true"
    })), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, "School:"), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("strong", null, props.details.listMetadata.school.map(function (e, i) {
      return i === 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement((react__WEBPACK_IMPORTED_MODULE_15___default().Fragment), {
        key: i
      }, e.replace("and", "&")) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement((react__WEBPACK_IMPORTED_MODULE_15___default().Fragment), {
        key: i
      }, "| ", e);
    })))),
    // City St George's label temporarily in place according to branding guidelines
    stGeorgesLabel = props.details.listMetadata && String(props.details.listMetadata.location).toLowerCase() === "tooting" ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("div", {
      className: "card__label card--course__label--stgeorges"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", {
      className: "fas fa-fw fa-map-marker-alt icon",
      "aria-hidden": "true"
    }), " ", "Tooting Campus")) : null,
    // City and Business School use different metadata values; check for both
    clearing = ((_props$details$listMe0 = props.details.listMetadata) === null || _props$details$listMe0 === void 0 ? void 0 : _props$details$listMe0.clearing) && ["Yes", "yes"].includes(props.details.listMetadata.clearing[0]) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("div", {
      className: "card__label card--course__label--clearing"
    ...
    external = !externalSiteUrl.some(function (s) {
      return props.details.indexUrl && props.details.indexUrl.indexOf(s) >= 0;
    }) ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement((react__WEBPACK_IMPORTED_MODULE_15___default().Fragment), null, " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", {
      className: "fas fa-sharp fa-external-link icon",
      "aria-label": "(external link)"
    })) : null,
    courseCode = props.details.listMetadata && props.details.listMetadata.code && (["Undergraduate degree", "Foundation course", "Postgraduate taught degree"].some(function (s) {
      return props.details.listMetadata && props.details.listMetadata.level && props.details.listMetadata.level.indexOf(s) >= 0;
    }) || props.query.query.indexOf(props.details.listMetadata.code[0]) >= 0) ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", {
      className: "card__tag"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, "UCAS code", props.details.listMetadata.code.length > 1 && 's', ":"), ' ', /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("strong", null, props.details.listMetadata.code.join('/')))) : null;

  // compute entryYears separately; ensure we don't rely on potentially undefined metadata
  var entryYears = null;
  var _entryyears = (_props$details$listMe1 = props.details.listMetadata) === null || _props$details$listMe1 === void 0 ? void 0 : _props$details$listMe1.entryyears;
  if (_entryyears && _entryyears.length > 0) {
    entryYears = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", {
      className: "card__tag"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, "Year", _entryyears.length > 1 && 's', " of entry:"), ' ', /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("span", null, _entryyears.map(function (year, idx) {
      var baseUrl = props.details.liveUrl;
      var href = idx > 0 ? "".concat(baseUrl, "/").concat(year) : baseUrl;
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement((react__WEBPACK_IMPORTED_MODULE_15___default().Fragment), {
        key: year
  ...
  var description = ((_props$details = props.details) === null || _props$details === void 0 || (_props$details = _props$details.listMetadata) === null || _props$details === void 0 || (_props$details = _props$details.c) === null || _props$details === void 0 ? void 0 : _props$details[0]) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", {
    className: "card__description"
  }, props.query.query ? (0,_results_formatLabel__WEBPACK_IMPORTED_MODULE_17__["default"])(props.details.listMetadata.c[0], props.query.query) : props.details.listMetadata.c[0]);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("li", {
    ...
    className: "wrapper--card__label__details"
  }, clearing, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("div", {
    className: "card__details__text"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("h3", {
    className: "card__heading"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("a", {
    href: props.details.liveUrl
  }, props.query.query ? (0,_results_formatLabel__WEBPACK_IMPORTED_MODULE_17__["default"])(props.details.title, props.query.query) : props.details.title, external)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("p", {
    className: "card__type"
  }, props.query.query && subtitle ? (0,_results_formatLabel__WEBPACK_IMPORTED_MODULE_17__["default"])(subtitle, props.query.query) : subtitle && subtitle), description, stGeorgesLabel, duration || courseCode ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("div", {
    className: "card--v26-course__duration-and-code"
  }, duration, courseCode) : null, entryYears, method, location || school ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default().createElement("div", {
    className: "card--v26-course__location"
  }, school, location) : null)));
}
Finder__Results__Coursev26.propTypes = {
  details: (prop_types__WEBPACK_IMPORTED_MODULE_18___default().object),
